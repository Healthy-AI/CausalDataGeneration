...
def setup_algorithms(training_data, dist, delta, train=True):
    ...
    algorithms = [
        NaiveDynamicProgramming(n_x, n_a, n_y, training_data, function_approximation, reward=-(delta*2+0.0001), name='Naive Dynamic Programming Function Approximation', label='NDP_F'),
    ]
...
def load_settings():
    ...
    n_data_sets = 4
    n_deltas = 10
    file_name_prefix = "AntibioticsNDPFunc2"
