...
if __name__ == '__main__':
    # Training values
    seed = 45617283  # Used for both synthetic and real data
    n_z = 3
    n_x = 1
    n_a = 5
    n_y = 3
    ...
    constraintStat = Constraint(split_training_data, n_a, n_y, approximator=statistical_approximation_n, delta=delta, epsilon=epsilon)
    ...
    algorithms = [
        ...
        ConstrainedDynamicProgramming(n_x, n_a, n_y, split_training_data, constraintTT, true_approximation, name="Dynamic Programming True", label="CDPT"),
        ConstrainedDynamicProgramming(n_x, n_a, n_y, split_training_data, constraintStat, statistical_approximation_n),
